module CssParser
  ...
  RE_BACKGROUND_POSITION_SIZE = Regexp.new("((((#{RE_LENGTH_OR_PERCENTAGE})|left|center|right|top|bottom)[\s]*){1,2})(/(cover|contain|inherit))?", Regexp::IGNORECASE | Regexp::EXTENDED)
